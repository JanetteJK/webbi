...
for (const restaurant of restaurants) {
  ...
  const nameTbl = document.createElement('td');
  const addressTbl = document.createElement('td');

  nameTbl.innerText = restaurant.name;
  addressTbl.innerText = restaurant.address

  table.append(nameTbl, addressTbl)
